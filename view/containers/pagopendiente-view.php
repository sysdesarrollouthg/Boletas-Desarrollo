...
<div style="display:flex;justify-content:center;align-items:center;min-height:70vh;">
    <div style="background:#fff;border-radius:20px;border:1px solid #e2e8f0;padding:48px 40px;max-width:480px;width:100%;text-align:center;box-shadow:0 4px 24px rgba(0,0,0,0.07);">
        ...
        <!-- Ícono pendiente -->
        <div style="width:72px;height:72px;background:linear-gradient(135deg,#ed8936,#c05621);border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 20px;box-shadow:0 4px 16px rgba(237,137,54,0.35);">
            <i class="fas fa-clock" style="color:#fff;font-size:2rem;"></i>
        </div>
        ...
        <h2 style="margin:0 0 8px;font-size:1.5rem;font-weight:800;color:#c05621;">Pago pendiente</h2>
        <p style="color:#718096;font-size:.9rem;margin-bottom:28px;">Tu pago está siendo procesado. La acreditación puede demorar algunas horas.</p>

        <?php if ($payment_id): ?>
        <div style="background:#fffaf0;border:1px solid #fbd38d;border-radius:10px;padding:12px 16px;margin-bottom:24px;text-align:left;">
            <?php if ($payment_id): ?>
        ...
        <p style="font-size:.78rem;color:#a0aec0;margin-bottom:28px;">
            Recibirás una notificación por email cuando el pago se acredite. Guardá el número de pago como comprobante.
        </p>
